...
const stats = [
  { value: "30+", label: "SAAS PRODUCTS BUILT" },
    ...
    >
      ...
      <Container size="lg" style={{ position: "relative", zIndex: 1 }}>
        <Stack gap={24} maw={650}>
          ...
          >
            Turn your software idea into a revenue-generating SaaS
            product. We build multi-tenant, cloud-native SaaS platforms
            from the ground up — designed for scale, subscription
            billing, and real user growth.
          </Text>
