...
const PPCHero = () => {
  ...
  const colors = {
    ...
    overlay: isDark
      ? "linear-gradient(90deg, rgba(6,8,8,0.94) 0%, rgba(6,8,8,0.9) 45%, rgba(6,8,8,0.75) 70%, rgba(6,8,8,0.6) 100%)"
      : "linear-gradient(90deg, rgba(255,255,255,0.96) 0%, rgba(255,255,255,0.92) 45%, rgba(255,255,255,0.78) 70%, rgba(255,255,255,0.55) 100%)",
  ...
  return (
    ...
    >
      {/* Background photo — professional digital-advertising/analytics shot */}
      <Box
        style={{
          position: "absolute",
          inset: 0,
          backgroundImage:
            "url('https://images.unsplash.com/photo-1553484771-371a605b060b?auto=format&fit=crop&w=1920&q=80')",
      ...
      >
        <Stack gap="xl" py={80} maw={720}>
          ...
          >
            Launch high-converting ad campaigns on Google, Meta, and
            LinkedIn. Stop wasting budget — our PPC experts maximise every
            rupee with data-driven precision.
          </Text>
