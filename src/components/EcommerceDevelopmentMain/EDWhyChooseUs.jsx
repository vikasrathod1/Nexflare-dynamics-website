...
const checklist = [
  "Certified Shopify Partners and WooCommerce experts",
  "Mobile-first design — 60%+ of purchases happen on mobile",
  "Sub-2-second load times — speed that directly impacts sales",
  "Built-in SEO foundations from page one",
  "Full integration with ERP, CRM, and logistics systems",
  "Ongoing CRO and analytics support post-launch",
];
const EDWhyChooseUs = () => {
      ...
      <Container size="lg">
        ...
        >
          ...
          <Stack gap={20}>
            ...
            >
              eCommerce That{" "}
              <span style={{ color: "#14b8a6" }}>Actually Sells</span>
            </Title>
            <Text
              style={{
                fontSize: "1.05rem",
            ...
            >
              We don't just build pretty stores — we build revenue
              machines. Every design and development decision is driven
              by conversion data and your business goals.
            </Text>
            <Stack gap={16} mt={10}>
