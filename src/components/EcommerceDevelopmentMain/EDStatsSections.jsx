...
const stats = [
  { value: "300+", label: "Stores Successfully Launched" },
  { value: "3.8x", label: "Average Conversion Rate Lift" },
  { value: "₹500Cr+", label: "Revenue Generated for Clients" },
  { value: "96%", label: "Client Satisfaction Rate" },
];
const EDStatsSections = () => {
...
export default EDStatsSections;