...
const stats = [
  ...
  { value: "300+", label: "STORES LAUNCHED" },
  ...
  return (
    <Box
      ...
      style={{
        position: "relative",
        overflow: "hidden",
        minHeight: "85vh",   // Added to ensure height
      }}
    >
      {/* Background image - Fully preserved and improved */}
      <Box
        style={{
          position: "absolute",
          inset: 0,
      ...
      <Container size="lg" style={{ position: "relative", zIndex: 2 }}>
        <Stack gap={24} maw={650}>
          ...
          >
            Build high-converting online stores that turn browsers into
            buyers. From custom Shopify stores to full-stack eCommerce
            platforms — engineered for sales, speed, and scale.
          </Text>
          {/* Buttons */}
          <Group gap="md" mt={8}>
            <Button
