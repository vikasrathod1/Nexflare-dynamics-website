...
const STATS = [
  { value: "3x", label: "Avg. ROI Improvement for Clients" },
  { value: "100+", label: "Custom Dashboards Delivered" },
  { value: "40%", label: "Avg. Reduction in Wasted Ad Spend" },
