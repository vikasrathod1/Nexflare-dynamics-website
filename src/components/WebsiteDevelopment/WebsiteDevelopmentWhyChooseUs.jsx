...
const checklist = [
  ...
  "Full source code ownership — no lock-ins",
  "Comprehensive QA testing before every launch",
  "30-day post-launch support included",
  "Detailed documentation for every project",
];
      ...
      <Container size="lg">
        ...
        >
          ...
          <Stack gap={20}>
            ...
            >
              Code That <span style={{ color: "#14b8a6" }}>Never Breaks</span>
            </Title>
            ...
            >
              We write clean, documented, and maintainable code that your
              team can take over — or we can manage it for you long-term.
            </Text>
