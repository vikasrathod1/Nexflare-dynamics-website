...
const CHECKLIST = [
  "Google-certified SEO specialists with 8+ years of experience",
  "100% white-hat techniques — no penalties, ever",
  "Dedicated account manager and monthly strategy calls",
  "Custom dashboards with real-time ranking tracking",
  "Full transparency — you own all your data and content",
  "Results-focused pricing with clear ROI reporting",
];
        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing={64} verticalSpacing={40}>
          ...
          <Stack gap={20}>
            <Stack gap={6}>
              ...
              >
                We don't promise overnight rankings — we build lasting
                organic growth through ethical, white-hat strategies that
