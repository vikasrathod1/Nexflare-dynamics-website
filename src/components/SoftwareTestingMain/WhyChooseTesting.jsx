        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing={64} verticalSpacing={40}>
          ...
          <Stack gap={20}>
            <Stack gap={6}>
              ...
              >
                We embed QA into your development lifecycle — not as a final
                gate, but as a continuous practice that catches issues early,
                reduces rework, and keeps release confidence high sprint
                after sprint.
              </Text>
            </Stack>
