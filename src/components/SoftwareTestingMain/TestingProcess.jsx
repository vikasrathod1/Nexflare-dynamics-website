...
const STEPS = [
  {
    ...
    description:
      "We study your specs, user stories, and acceptance criteria to build a comprehensive test plan that covers all functional and non-functional requirements.",
  },
  {
    number: "02",
    title: "Test Design & Strategy",
    description:
      "Detailed test cases, automation scripts, and a testing matrix across browsers, devices, and environments — reviewed and agreed before execution begins.",
  },
  {
    number: "03",
    title: "Execution & Reporting",
    description:
      "Systematic test execution with detailed bug reports, severity classification, and real-time dashboards — so your dev team always knows what needs fixing and why.",
  },
  {
    number: "04",
    title: "Regression & Sign-Off",
    description:
      "Post-fix regression testing, final quality sign-off, and handover of documented test assets — so your team can maintain quality independently going forward.",
  },
];
    ...
    <Box component="section" style={{ padding: "96px 0" }}>
      <Container size="xl">
        <Stack gap={6} maw={720} mb={64}>
          ...
          >
            A structured, repeatable QA process that fits into your
            development workflow — delivering clean releases without slowing
            your team down.
          </Text>
        </Stack>
