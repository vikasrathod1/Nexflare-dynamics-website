...
// export default function RefundPolicy({ colorScheme, onColorSchemeChange } = {}) {
//   // If a parent app passes `colorScheme` ("dark" | "light"), that value always
//   // wins and this component's own toggle buttons are hidden — the page just
//   // renders whatever theme the host app is currently in (e.g. Mantine's
//   // useComputedColorScheme(), a Redux/Context value, next-themes, etc).
//   // If no colorScheme prop is passed, the component manages its own theme
//   // state internally and shows its built-in toggle, exactly as before.
//   const isControlled = colorScheme === "dark" || colorScheme === "light";
//   const [internalTheme, setInternalTheme] = useState("dark");
//   const theme = isControlled ? colorScheme : internalTheme;
//   const setTheme = isControlled
//     ? (next) => onColorSchemeChange?.(next)
//     : setInternalTheme;
...
//               aria-label={mode === "dark" ? "Dark theme" : "Light theme"}
//             >
//               {mode === "dark" ? "🌙" : "☀️"}
//             </button>
//           ))}
