...
const LetsBuildTogether = () => {
  ...
  const watermarkColor = isDark ? "rgba(255,255,255,.03)" : "rgba(15,23,42,.04)";
  ...
  return (
    <Box component="section" py={80} style={{ position: "relative", overflow: "hidden" }}>
      {/* Watermark text */}
      <Text
        aria-hidden
        style={{
      ...
      <Container size="md" style={{ position: "relative", zIndex: 1 }}>
        <Stack align="center" gap={0}>
          ...
          >
            ...
            tools that enhance your digital footprint and accelerate business
            success across India and beyond.
          </Text>
