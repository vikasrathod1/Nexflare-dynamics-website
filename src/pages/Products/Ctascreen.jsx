    ...
    <Box component="section" py={{ base: 48, md: 72 }}>
      <Container size="lg">
        ...
        >
          ...
          <Stack gap={0} align="center" ta="center" style={{ position: "relative" }} mx="auto" maw={640}>
            <Text
              fw={700}
              size="xs"
              mb={18}
            ...
            <Text mt={22} size="md" style={{ color: bodyColor, lineHeight: 1.7 }}>
              From HRM and ERP to CRM, mobile apps, and booking systems — the
              entire Nexflare suite is designed to work together and
              accelerate your growth. Get a free consultation today.
            </Text>
